...
const platformBtn = {
  ...
  color: "#f0ede8", fontFamily: F,
  fontSize: "11px", fontWeight: 400, letterSpacing: "0.2em", textTransform: "uppercase",
  ...
  if (!release) return (
    <div style={{ backgroundColor: "#000", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "24px" }}>
      ...
      <button onClick={() => navigate("/releases")}
        style={{ ...platformBtn, width: "auto", padding: "10px 24px", border: "1px solid #2a2a2a", borderTop: "1px solid #2a2a2a" }}>
        ← All Releases
      </button>
    </div>
  );
    ...
    return (
      <div style={{ backgroundColor: "#000", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "80px 20px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: "420px" }}>
          ...
          {hasSmartLink && (
            <a href={release.smartLink} target="_blank" rel="noreferrer"
              style={{ ...platformBtn, borderTop: "1px solid #f0ede8", opacity: 1 }}
  ...
  return (
    <div style={{ backgroundColor: "#000", color: "#f0ede8", minHeight: "100vh", fontFamily: F, position: "relative" }}>
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: "480px", margin: "0 auto", paddingTop: "60px" }}>
        ...
        {/* Title block */}
        <div style={{ padding: "24px 24px 20px", textAlign: "center", borderBottom: "1px solid #1a1a1a" }}>
          <h1 style={{ fontFamily: F, fontSize: "14px", fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", color: "#f0ede8", marginBottom: "8px", lineHeight: 1.4 }}>
            {release.artist} — {release.title}
          </h1>
        ...
        <div>
          ...
          {hasApple && (
            <a href={release.appleUrl} target="_blank" rel="noreferrer" style={platformBtn}
              onMouseOver={e => e.currentTarget.style.opacity = 0.6}
              onMouseOut={e => e.currentTarget.style.opacity = 1}>
          ...
          {hasYouTube && (
            <a href={release.youtubeUrl} target="_blank" rel="noreferrer" style={platformBtn}
              onMouseOver={e => e.currentTarget.style.opacity = 0.6}
              onMouseOut={e => e.currentTarget.style.opacity = 1}>
          ...
          {!hasAnyPlatform && hasSmartLink && (
            <a href={release.smartLink} target="_blank" rel="noreferrer" style={platformBtn}
              onMouseOver={e => e.currentTarget.style.opacity = 0.6}
              onMouseOut={e => e.currentTarget.style.opacity = 1}>
              <span>Listen</span>
            </a>
